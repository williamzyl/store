...
<script type="text/javascript">
   ...
   function addToCart() {
	...
	location.href="${pageContext.request.contextPath}/product?method=addShopCar&pid=${product.pid}&num="+num;
  }
</script>
</head>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath }/default.jsp">首页&nbsp;&nbsp;&gt;</a> <a href="${pageContext.request.contextPath }/productListByCid?cid=${category.cid }">${category.cname }&nbsp;&nbsp;&gt;</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						促销: <a target="_blank" title="限时抢购 (2017-11-30 ~ 2018-01-01)"
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:;" onclick="addToCart()"> <input
