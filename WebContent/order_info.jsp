	...
	<div class="container">
		...
		<div>
			...
			<form class="form-horizontal"
				style="margin-top: 5px; margin-left: 150px;" action="${pageContext.request.contextPath }/product?method=confirmOrder" method="post">
				<div class="form-group">
					<label for="username" class="col-sm-1 control-label">地址</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="username" value="${order.address }" name="address"
							placeholder="请输入收货地址">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="password" class="form-control" id="inputPassword3" value="${order.name }" name="name"
							placeholder="请输收货人">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="password" class="form-control" id="confirmpwd" value="${order.telephone }" name="telephone"
							placeholder="请输入联系方式">
					</div>
				</div>
			</form>
